  ...
  useEffect(() => {
    const handleScroll = () => {
      if (window.scrollY > 50) {
        // trigger shrink after 50px scroll
        setIsScrolled(true);
      } else {
        setIsScrolled(false);
      }
      ...
      >
        <div className=" mx-auto flex items-center justify-between px-4 py-3">
          ...
          <div className="hidden lg:flex space-x-8">
            {/* Search Bar (Desktop) */}
            <div className="hidden lg:flex items-center border-stone-500 border rounded-xl px-2">
              <input
                type="text"
            ...
            <div className="hidden lg:flex ">
              <Link
                to="https://github.com/HmNsd" target="_blank" rel="noopener noreferrer"
                className="text-white font-semibold bg-gradient-to-br from-[#232323] to-[#616466] focus:ring-1  focus:ring-stone-100 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 focus:outline-none "
              >
                GitHub
              </Link>
              <Link
                to="https://www.linkedin.com/in/hmnsd/" target="_blank" rel="noopener noreferrer"
                className="text-white font-semibold bg-gradient-to-br from-[#0454a4] to-[#3993ed] focus:ring-1 focus:ring-black font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 focus:outline-none"
              >
                LinkedIn
              </Link>
            </div>
          ...
          <button
            ...
            className="hidden lg:block p-2 rounded-full hover:bg-stone-600 transition-colors"
            style={{
              border: `1px solid ${
          ...
          >
            {isDark ? (
              <SunIcon className="w-5 h-5" style={{ color: "#ffffff" }} />
            ) : (
              <MoonIcon className="w-5 h-5" style={{ color: "#000000" }} />
            )}
          </button>
          </div>
          ...
          <div className="flex lg:hidden items-center space-x-4">
            ...
            >
              {isDark ? (
                <SunIcon className="w-6 h-6" style={{ color: "#ffffff" }} />
              ) : (
        ...
        {isOpen && (
          ...
          >
            ...
            <div className="flex space-x-4 mt-4">
              ...
              <Link
                to="https://github.com/HmNsd" target="_blank" rel="noopener noreferrer"
                className="flex-1 px-4 py-2 text-white text-center bg-black hover:bg-orange-500 focus:ring-1 focus:ring-black font-medium border-stone-500 border rounded-lg text-sm focus:outline-none"
                onClick={() => setIsOpen(false)}
              >
                GitHub
              </Link>
